          ...
          return Scaffold(
            ...
            body: Stack(
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            controller.setHasChildAccount(true);
                          },
                          child: Container(
                            width: double.infinity,
                            padding: const EdgeInsets.all(16),
                            decoration: BoxDecoration(
                              color: controller.hasChildAccount == true
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: controller.hasChildAccount == true
                                      ? const Icon(
                                          Icons.check,
                                          color: Colors.white,
                                          size: 12,
                        ...
                        GestureDetector(
                          onTap: () {
                            controller.setHasChildAccount(false);
                          },
                          child: Container(
                            width: double.infinity,
                            padding: const EdgeInsets.all(16),
                            decoration: BoxDecoration(
                              color: controller.hasChildAccount == false
                                  ? BColors.primary.withValues(alpha: 0.1)
                                  : BColors.softGrey,
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: controller.hasChildAccount == false
                                      ? const Icon(
                                          Icons.check,
                                          color: Colors.white,
                                          size: 12,
                ...
                NextButton(
                  onPressed: controller.hasChildAccount != null
                      ? () {
                          if (controller.hasChildAccount == true) {
                          ...
                          } else if (controller.hasChildAccount == false) {
