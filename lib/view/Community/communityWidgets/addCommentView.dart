...
class AddCommentView extends StatefulWidget {
  ...
  const AddCommentView({super.key, required this.promptMessage, required this.postId});
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "Note that comments cannot exceed 180 characters, be empty or only contain special characters.",
              ...
              Obx(() {
                ...
                final errorText = shouldShowError
                    ? (postController.hasRestrictedContent.value
                          ? "Your comment contains restricted content."
                ...
                () => SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed:
                        ...
                        ? () async {
                            final commented = await postController.addComment(
                              context,
                             widget.postId,
                            );
                            if (commented) {
